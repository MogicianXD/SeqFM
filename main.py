...
def parse_args():
    ...
    parser.add_argument('--cuda', default='5',
                        help='gpu No.')
...
model.train_test(fn[task][0], fn[task][1], train, valid, test, savepath=args.savepath, reload=args.reload,
                 n_epochs=args.epochs, lr=args.lr, topk=task=='rank', small_better=small_better, ref=ref)
